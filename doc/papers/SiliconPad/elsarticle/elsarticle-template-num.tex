...
calorimeter prototypes~\cite{Muhuri201424}. The RMS of the integrated charge at
each absorber thickness is relatively large, due to a small size of the active
element used in the experiment. We also observe that the time resolution
improves as the shower develops towards its maximum in the longitudinal
direction. 
...
conditions during our test beam time. We also appreciate the technical support of 
