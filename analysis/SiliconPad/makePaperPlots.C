...
/*void makePaperPlots(){
  ...
  TFile *_file0 = TFile::Open("run112_lin30_DeltaT.root");
  TFile *_file1 = TFile::Open("run109_lin30_DeltaT.root");
  TFile *_file2 = TFile::Open("run110_lin30_DeltaT.root");
  TFile *_file3 = TFile::Open("run114_lin30_DeltaT.root");
...
void makePaperPlots(){
  ...
  TFile *_file0 = TFile::Open("run119_lin30_DeltaT.root");
  TFile *_file1 = TFile::Open("run118_lin30_DeltaT.root");
  TFile *_file2 = TFile::Open("run117_lin30_DeltaT.root");
  TFile *_file3 = TFile::Open("run116_lin30_DeltaT.root");
...
void makePaperPlots(){
  ...
  TFile *_file0 = TFile::Open("run111-234_lin30_DeltaT.root");
  TFile *_file1 = TFile::Open("run111-1_lin30_DeltaT.root");
  TFile *_file2 = TFile::Open("run111-0_lin30_DeltaT.root");
  TFile *_file3 = TFile::Open("run110_lin30_DeltaT.root");
