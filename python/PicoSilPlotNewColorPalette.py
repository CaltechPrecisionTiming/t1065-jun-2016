...
def set_palette(name="default", ncontours=999):
    ...
    # elif name == "whatever":
        ...
        stops = [0.00, 0.34, 0.61, 0.90, 1.00]
        red   = [0.00, 0.00, 0.87, 0.7, 1.00]
        green = [0.00, 0.81, 1.00, 1.00, 0.00]
        blue  = [0.51, 1.00, 0.12, 0.08, 0.00]
...
if __name__ == '__main__':
    ...
    l.SetTextAlign(12)
    l.DrawLatex(0.6,0.85,"ring0 sum: %.1f"%(ring0sum))
    l.DrawLatex(0.6,0.80,"ring1 sum: %.1f"%(ring1sum))
    l.DrawLatex(0.6,0.75,"ring2 sum: %.1f"%(ring2sum))
